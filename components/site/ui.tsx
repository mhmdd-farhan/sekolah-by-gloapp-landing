...
export function Eyebrow({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-full border border-gradient-brand bg-accent/40 px-3.5 py-1 font-mono text-xs uppercase tracking-widest text-accent-foreground">
      {children}
    </span>
  );
}
